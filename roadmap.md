...
- App shell + nav + ⌘K palette, Event Desk, Pick handoff
- Metadata desk, Packages, Adobe handoff, Send/Delivery, Clients, Business, Settings
- Portfolio builder (upload own photos + write about them)

## Open
- [ ] Linear-style multi-column footer (dark, like reference screenshot) across site
