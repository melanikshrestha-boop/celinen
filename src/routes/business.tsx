...
export const Route = createFileRoute("/business")({
  head: () => ({
    meta: [
      { title: "Business — Lens OS Job Economics" },
      {
        name: "description",
        content:
          "Production facts Lens OS can actually know, plus manual money fields. Unknown values stay blank — never a fake $0 profit.",
      },
      { property: "og:title", content: "Business — Lens OS Job Economics" },
      {
