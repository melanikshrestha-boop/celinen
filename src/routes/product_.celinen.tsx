...
export const Route = createFileRoute("/product_/celinen")({
  head: () => publicContentHead("Celinen", description, "/product/celinen"),
  component: CelinenProductPage,
});

export function CelinenProductPage() {
  return (
    <PublicPage eyebrow="Celinen" title="A home for the whole shoot." description={description}>
