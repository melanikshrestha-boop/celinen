...
const pages = {
  ...
  settings: {
    ...
    paragraphs: [
      ...
      "Theme and settings imports accept bounded Celinen JSON, show a confirmation, and never execute code. Imported preferences cannot enable cloud sharing or desktop notifications. Changing the theme does not modify photographs.",
  ...
  security: {
    ...
    paragraphs: [
      "Security reports: hello@lenslab.dev. See Workspace permissions for the controls in this build. We do not claim SOC 2, ISO 27001, or similar certification.",
    ],
  },
} as const;
...
export function SettingsGuide({ page }: { page: SettingsGuidePage }) {
  ...
  return (
    <PublicPage eyebrow="A little clarity" title={entry.title}>
      ...
      <nav className="marketing-guide-links" aria-label="Celinen guides">
