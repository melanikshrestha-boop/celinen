...
export function ComparePage() {
  ...
  return (
    <div className="celinen-compare">
      <header className="celinen-compare__intro" data-reveal>
        <p className="celinen-compare__eyebrow">Comparisons</p>
      ...
      <CompareCards />
      <section className="celinen-compare__more" data-reveal>
      ...
      <p className="celinen-compare__note" data-reveal>
      ...
      <section className="celinen-compare__try" data-reveal>
